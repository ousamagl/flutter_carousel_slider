...
class CarouselSliderState extends State<CarouselSlider> with TickerProviderStateMixin {
  ...
  Widget getEnlargeWrapper(Widget? child,
      {double rotation = 1, double? width, double? height, double? scale, required double itemOffset}) {
        ...
        return AnimatedBuilder(
          ...
          builder: (BuildContext context, child) {
            ...
            if (widget.options.enlargeCenterPage != null && widget.options.enlargeCenterPage == true) {
              ...
              distortionValue = Curves.easeOut.transform(distortionRatio.toDouble());
            ...
            if (widget.options.scrollDirection == Axis.horizontal) {
              return getCenterWrapper(getEnlargeWrapper(
                ...
                rotation: (1 - distortionValueForRotation) * options.otherPagesRotation * -0.0174533 * itemOffset.sign,
              ));
            } else {
              return getCenterWrapper(getEnlargeWrapper(
                child,
